...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \addplot[very thick, blue] coordinates {
            (0,22.3) (50,24.5) (100,28.2) (150,31.6) (200,35.1) (250,38.3) (300,41.2) (350,43.9) (400,46.2) (450,47.5) (500,48.0)
        };
        \addplot[very thick, dashed, red] coordinates {
            (0,22.1) (50,23.8) (100,26.4) (150,28.9) (200,30.5) (250,33.2) (300,35.4) (350,37.8) (400,39.6) (450,41.7) (500,42.4)
        };
        \addplot[very thick, dotted, black] coordinates {
            (0,22.4) (50,24.3) (100,27.1) (150,29.7) (200,32.3) (250,34.6) (300,36.8) (350,38.5) (400,40.3) (450,41.6) (500,42.9)
        };
        \addplot[very thick, dashdotted, green!60!black] coordinates {
            (0,22.5) (50,25.8) (100,29.4) (150,33.2) (200,37.0) (250,40.3) (300,43.1) (350,45.2) (400,46.7) (450,47.8) (500,48.0)
        };
        
        \draw[dashed] (350,43.9) -- (500,43.9);
        \node[anchor=west] at (360,44.5) {\small Static Distribution (500k steps)};
        
        \draw[dashed] (190,43.9) -- (190,20);
        \node[anchor=north] at (190,20.5) {\small AdaptDifficulty (190k steps)};
        
        \legend{AdaptDifficulty, Static Distribution, Manual Curriculum, Difficulty-Based}
        \end{axis}
    \end{tikzpicture}
    \caption{Training curves showing performance on BeyondAIME benchmark. AdaptDifficulty reaches the final performance of static distribution training in only 38\% of the training steps.}
...
\begin{table}[htbp]
  ...
  \begin{minipage}[t]{0.45\linewidth}
    ...
    \label{tab:ranking}
  \end{minipage}
  % \caption{Combined results from two experiments.}
  \label{tab:combined}
\end{table}
